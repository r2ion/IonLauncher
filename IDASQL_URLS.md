...
| `tier0.dll` | `C:\Program Files\EA Games\Titanfall2\bin\x64_retail\tier0.dll.i64` | HTTP | `http://127.0.0.1:8119` | `2026-08-15T06:20:06Z` | Verified; SHA-256 `2ff3a9bf91d67b8d8e2c3c08eba4c8b38e8d39cb876d910d9f187ff1af4f2df0`. Previous listener `http://127.0.0.1:8132` is no longer active. |
...
| `materialsystem_dx11.dll` | `C:\Program Files\EA Games\Titanfall2\bin\x64_retail\materialsystem_dx11.dll.i64` | HTTP | `http://127.0.0.1:8144` | `2026-08-15T06:20:06Z` | Verified; SHA-256 `1afffb8dfe2a97a00ca3c5a68ca5277249176c2fd51ee7c5ad70f6eb699a6050`. Previous listener `http://127.0.0.1:8141` is no longer active. |
| `datacache.dll` | `C:\Users\Will\Documents\portal2_engine_bins\bin\datacache.dll.i64` | HTTP | `http://127.0.0.1:8144` | `2026-08-09T11:08:54Z` | Stale; previously verified as SHA-256 `3dcd1924ae76c94d2bb92f503345be36b6dd6f9fecd3784e443469d25cb53bac`; port now serves Titanfall 2 `materialsystem_dx11.dll`. |
...
| `vgui2.dll` | `C:\Program Files\EA Games\Titanfall2\bin\x64_retail\vgui2.dll.i64` | HTTP | `http://127.0.0.1:8184` | `2026-08-13T06:57:39Z` | Verified; SHA-256 `7fe2e4914db6bc3c4dfb2620327c48bb964a6c2267d522b028ace9c63606110f`. |
| `vguimatsurface.dll` | `C:\Program Files\EA Games\Titanfall2\bin\x64_retail\vguimatsurface.dll.i64` | HTTP | `http://127.0.0.1:8116` | `2026-08-14T04:41:36Z` | Verified IDB path and `ISurface`/`IMatSystemSurface` RTTI; this IDB's `binary` metadata omits the filename and SHA-256. Local DLL SHA-256 `bc05f50e777261ed5f1672a33e7d3da7ef7a97d188380f628ad1fe5a0d4b05c6`. |

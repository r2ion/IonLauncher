...
static_assert(sizeof(InputEvent_t) == 0x14);
static_assert(offsetof(InputEvent_t, m_nType) == 0x0);
static_assert(offsetof(InputEvent_t, m_nTick) == 0x4);
static_assert(offsetof(InputEvent_t, m_nData) == 0x8);
static_assert(offsetof(InputEvent_t, m_nData2) == 0xC);
static_assert(offsetof(InputEvent_t, m_nData3) == 0x10);

...
static_assert(sizeof(KeyValues) == 0x48);
static_assert(alignof(KeyValues) == 0x8);
static_assert(offsetof(KeyValues, m_sValue) == 0x8);
static_assert(offsetof(KeyValues, m_wsValue) == 0x10);
static_assert(offsetof(KeyValues, m_pValue) == 0x18);
static_assert(offsetof(KeyValues, m_szShortName) == 0x20);
static_assert(offsetof(KeyValues, m_iDataType) == 0x28);
static_assert(offsetof(KeyValues, m_bHasEscapeSequences) == 0x29);
static_assert(offsetof(KeyValues, m_iKeyNameCaseSensitive2) == 0x2A);
static_assert(offsetof(KeyValues, m_pPeer) == 0x30);
